/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 1e3c0fb51762289c6d044b990cba6b86)
// Runtime types generated with workerd@1.20250428.0 2025-04-30 
declare namespace Cloudflare {
	interface Env {
		KHQR_WEBHOOK: KVNamespace;
		NODE_ENV: string;
		BAKONG_REGISTERED_EMAIL: string;
		TIMEOUT_IN_MINUTES: string;
		WEBHOOK_SECRET_KEY: string;
		API_KEY: string;
		TRX_WORKFLOW: Workflow;
